...
class User {
  ...
  final String? jabatanId; //2# Integer to String
  final String? departemenId; //2# Integer to String
  final String? shiftKerjaId; //2# Integer to String
  ...
  factory User.fromMap(Map<String, dynamic> json) => User(
        ...
        faceEmbedding: json["face_embedding"], //2#
