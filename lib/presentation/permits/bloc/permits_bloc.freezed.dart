...
mixin _$PermitsEvent {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is PermitsEvent);
  }
...
class _Started implements PermitsEvent {
  const _Started();
  ...
  @override
  String toString() {
    return 'PermitsEvent.started()';
  }
}

/// @nodoc

class _GetAllPermits implements PermitsEvent {
  const _GetAllPermits({this.status});

  final String? status;

  /// Create a copy of PermitsEvent
  ...
  @override
  String toString() {
    return 'PermitsEvent.getAllPermits(status: $status)';
  }
}

/// @nodoc
abstract mixin class _$GetAllPermitsCopyWith<$Res>
    implements $PermitsEventCopyWith<$Res> {
...
mixin _$PermitsState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is PermitsState);
  }
...
/// @nodoc
class $PermitsStateCopyWith<$Res> {
  $PermitsStateCopyWith(PermitsState _, $Res Function(PermitsState) __);
}
...
extension PermitsStatePatterns on PermitsState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(LeaveResponseModel response)? success,
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(LeaveResponseModel response) success,
...
class _Initial implements PermitsState {
  const _Initial();
  ...
  @override
  String toString() {
    return 'PermitsState.initial()';
  }
}

/// @nodoc

class _Loading implements PermitsState {
  const _Loading();
  ...
  @override
  String toString() {
    return 'PermitsState.loading()';
  }
}

/// @nodoc

class _Success implements PermitsState {
  const _Success(this.response);

  final LeaveResponseModel response;
  ...
  @override
  String toString() {
    return 'PermitsState.success(response: $response)';
  }
}
...
abstract mixin class _$SuccessCopyWith<$Res>
  ...
  @useResult
  $Res call({LeaveResponseModel response});
}
...
class _Error implements PermitsState {
  ...
  @override
  String toString() {
    return 'PermitsState.error(message: $message)';
  }
}
